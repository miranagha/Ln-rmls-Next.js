        ...
        return (
            <section>
                <div className="main-container col-lg-12">
                    <br />
                    <h1 className='text-center' >Outstanding London Removals Company</h1>
                    <br />
                ...
                <article>
                    <br />
                    <h2 className='h2'>Top removal experts in London</h2>
                    <p>
                    ...
                    <h2 className='h2'>Office removals London</h2>
                    <p>
                    ...
                    <p>
                        ...
                        today if you’ve been looking for the best office and house removals in London?
        </p>
