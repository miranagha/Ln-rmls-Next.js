...
const Modal3 = ({ nextActivModal, previousActivModal, toggle }) => (
    <div>
        ...
        <p> Some items require extra care to protect them from getting scratched or damaged such as piano, antiques, or expensive furniture. During the moving process, they must have specialised equipment to make sure that the transportation is safe includes lifts, trolley, carrying straps or special blankets.</p>
        <Row>
            <Col>
