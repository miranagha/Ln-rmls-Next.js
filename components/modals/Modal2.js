...
const Modal2 = ({ nextActivModal, previousActivModal, toggle }) => (
    <div>
        ...
        <p> Finding out what their customers say is one of the best ways to gauge how good the company is. You can check their Google 
        My Business page(s) and look at some of their good and bad reviews. It is really important to check how the company responded 
        to customer reviews, especially when they're bad.</p>
        <Row>
            <Col>
