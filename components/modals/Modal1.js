...
const Modal1 = ({ nextActivModal, toggle }) => (
	<div>
		...
		<p>During the relocation process, it is crucial that the moving company take full care and responsibility for what happened to all your furniture and personal belongings. This means if any of your items are damaged in transit, will be covered by the company.</p>
