...
const AsideText = () => (
	<aside>
		<h2 className='h2'>Round-the-clock assistance</h2>
		<p> We offer a 24/7 service designed to fit around your schedule. Our
		fast-growing reputation means more residential and business customers
		are choosing us. No matter when you need to move, we can help. We have
		no problem with assisting you during weekends, public holidays or unsociable
